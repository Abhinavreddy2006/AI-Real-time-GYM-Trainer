...
class SquatsDetector(BaseExercise):
    ...
    def process(self, landmarks):
        ...
        key_landmark_visible = landmarks[hip_idx].visibility >= self.MIN_VISIBILITY and landmarks[knee_idx].visibility >= self.MIN_VISIBILITY and landmarks[ankle_idx] >= self.MIN_VISIBILITY
